...
| 数组A和数组B的相关性 | ![img](https://gitee.com/chi2b/pic-clound/raw/master/img/XwYEh8-AUcIxFt2zVQ-sEg)<br/>**这里A=[a1, a2,...ak,..., an],B=[b1, b2,...bk,..., bn]<br/>mean(A)代表A中元素的平均值std是标准差，即对协方差的开平方.<br/>点乘的定义：** ![Image text](https://raw.github.com/YONGLE123/GZHU_Data_mining_Course/master/image-folder/4.png)|
